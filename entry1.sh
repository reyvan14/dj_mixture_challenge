...
MIXTURE_SCRIPT="${SCRIPT_DIR}/solution/get_mixture1.py"
...
add_param train_cmd "--model" "/root/autodl-tmp/Baichuan2-7B-Base"
add_param train_cmd "--int8" "${INT8}"
add_param train_cmd "--dtype" "${COMPUTE_TYPE}"
add_param train_cmd "--data" "${SCRIPT_DIR}/output/sft_data/shuffled_mixture.jsonl"
...
add_param eval_cmd "--model" "/root/autodl-tmp/Baichuan2-7B-Base"
